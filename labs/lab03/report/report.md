...
author: "Уржиндорж Мягмар НКАбд-04-23"
...
![Пользователь git](image/03.png){ #fig:003 width=70%, height=70% }

Далее создаю ключи для идентификации.

![Ключ для подписи](image/04.png){ #fig:004 width=70%, height=70% }
...
![commit push](image/07.png){ #fig:007 width=70%, height=70% }
